...
private:
	...
	void privateSetSFXVolume(float p_volume);
	void privateSetBGMVolume(float p_volume);
...
public:
	...
	static void setSFXVolume(float p_volume);
	static float getSFXVolume();

	static void setBGMVolume(float p_volume);
