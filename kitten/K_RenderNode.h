...
namespace kitten
{
	...
	private:
		...
		std::unordered_set<puppy::P_UIRenderable*> m_uiRenderables;
	...
	public:
		...
		void addUIRenderable(puppy::P_UIRenderable* p_toAdd);
		void removeUIRenderable(puppy::P_UIRenderable* p_toRemove);
	};
}