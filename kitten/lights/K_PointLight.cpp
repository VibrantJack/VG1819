...
namespace kitten
{
	K_PointLight::K_PointLight(const glm::vec3& p_pointColor, const glm::vec3& p_attenuation, const float& p_range, bool p_useTransformCallbacks) : m_usingCallbacks(p_useTransformCallbacks)
	{
