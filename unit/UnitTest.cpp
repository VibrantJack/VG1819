...
//		uNEWDUMMY2->getComponent<unit::UnitMove>()->setTile(-1, -1);
		...
		*/
		...
		u0->getComponent<unit::UnitMove>()->setTile(2, 3);
		...
		u3->getComponent<unit::UnitMove>()->setTile(2, 6);


		kitten::K_GameObject* u4 = UnitSpawn::getInstance()->spawnUnitObject(4);//engineer
		u4->getComponent<unit::UnitMove>()->setTile(3, 3);
		...
		u6->getComponent<unit::UnitMove>()->setTile(3, 5);
		...
		u18->getComponent<unit::UnitMove>()->setTile(6, 4);
		...
		u192->getComponent<unit::UnitMove>()->setTile(7, 2);
